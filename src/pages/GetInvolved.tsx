  ...
  return (
    <>
      ...
      <section
        ...
        className="bg-gradient-to-br from-primary to-accent text-white py-12 md:py-16"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav aria-label="Breadcrumb" className="mb-4">
            <ol className="flex items-center gap-2 text-sm text-white/70">
              ...
              <li className="text-white" aria-current="page">Get Involved</li>
            </ol>
          </nav>
      ...
      <section aria-labelledby="routes-heading" className="py-16 md:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Volunteer */}
            <div className="bg-white dark:bg-slate-800 rounded-xl p-8 border border-border dark:border-dark-border shadow-sm hover:shadow-md transition-shadow">
              <div className="w-14 h-14 rounded-xl bg-primary/10 flex items-center justify-center mb-6">
                <Heart className="text-primary dark:text-accent-light" size={28} aria-hidden="true" />
              </div>
            ...
            <div className="bg-white dark:bg-slate-800 rounded-xl p-8 border border-border dark:border-dark-border shadow-sm hover:shadow-md transition-shadow">
              <div className="w-14 h-14 rounded-xl bg-accent/10 flex items-center justify-center mb-6">
                <Building2 className="text-accent dark:text-accent-light" size={28} aria-hidden="true" />
              </div>
              <h3 className="text-xl font-bold text-ink dark:text-white mb-3">
                Partner With Us
              </h3>
            ...
            <div className="bg-white dark:bg-slate-800 rounded-xl p-8 border border-border dark:border-dark-border shadow-sm hover:shadow-md transition-shadow">
              <div className="w-14 h-14 rounded-xl bg-primary/10 flex items-center justify-center mb-6">
                <HeartHandshake className="text-primary dark:text-accent-light" size={28} aria-hidden="true" />
              </div>
              <h3 className="text-xl font-bold text-ink dark:text-white mb-3">
                Support Our Cause
              </h3>
      ...
      <section aria-labelledby="notice-heading" className="py-12 md:py-16 bg-subtle dark:bg-dark-surface">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white dark:bg-slate-800 rounded-xl p-6 md:p-8 border border-border dark:border-dark-border">
            <div className="flex items-start gap-4">
              <div className="w-10 h-10 rounded-full bg-accent/10 flex items-center justify-center shrink-0">
                <Shield className="text-accent" size={20} aria-hidden="true" />
              </div>
              <div>
                <h2 id="notice-heading" className="text-lg font-bold text-ink dark:text-white mb-2">
                ...
                <p className="text-muted dark:text-dark-muted text-sm leading-relaxed">
                  ...
                  <a href={`tel:${orgData.contact.phoneTel}`} className="text-primary dark:text-accent-light font-medium hover:underline">
                    {orgData.contact.phone}
                  </a>{" "}
                  or{" "}
                  <a href={`mailto:${orgData.contact.email}`} className="text-primary dark:text-accent-light font-medium hover:underline">
      ...
      <section aria-labelledby="contact-cta-heading" className="py-16 md:py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 id="contact-cta-heading" className="text-2xl md:text-3xl font-bold text-ink dark:text-white mb-4">
