...
import { Target, Eye, Heart, ArrowRight, Award, Users, BookOpen } from "lucide-react";

/**
 * About Us Page
 * 
 * Organization overview, vision & mission, impact highlights,
 * and founding date callout.
 */
      ...
      <section aria-labelledby="overview-heading" className="py-16 md:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <h2 id="overview-heading" className="text-2xl md:text-3xl font-bold text-ink dark:text-white mb-6">
              Who We Are
            </h2>
            <div className="prose text-muted dark:text-dark-muted space-y-4 text-lg leading-relaxed">
              <p>
                <strong className="text-ink dark:text-white">{orgData.legalName}</strong> ({orgData.shortName}) is a{" "}
                {orgData.type.toLowerCase()}. We were founded on{" "}
                <time dateTime={orgData.founded} className="font-semibold text-ink dark:text-white">
      ...
      <section aria-labelledby="vm-heading" className="py-16 md:py-20 bg-subtle dark:bg-dark-surface">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Vision */}
            <div className="bg-white dark:bg-slate-800 rounded-xl p-8 border border-border dark:border-dark-border">
              <div className="w-14 h-14 rounded-xl bg-primary/10 flex items-center justify-center mb-6">
                <Eye className="text-primary dark:text-accent-light" size={28} aria-hidden="true" />
              </div>
              <h3 className="text-xl font-bold text-ink dark:text-white mb-4">Our Vision</h3>
            ...
            <div className="bg-white dark:bg-slate-800 rounded-xl p-8 border border-border dark:border-dark-border">
              <div className="w-14 h-14 rounded-xl bg-accent/10 flex items-center justify-center mb-6">
                <Target className="text-accent dark:text-accent-light" size={28} aria-hidden="true" />
              </div>
              <h3 className="text-xl font-bold text-ink dark:text-white mb-4">Our Mission</h3>
              <p className="text-muted dark:text-dark-muted leading-relaxed">
      ...
      <section aria-labelledby="impact-heading" className="py-16 md:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 id="impact-heading" className="text-2xl md:text-3xl font-bold text-ink dark:text-white mb-4">
              Impact Highlights
            </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center p-6 bg-white dark:bg-slate-800 rounded-xl border border-border dark:border-dark-border">
              <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center mx-auto mb-4">
                <BookOpen className="text-primary" size={24} aria-hidden="true" />
              </div>
              <h3 className="font-bold text-ink dark:text-white mb-2">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-white dark:bg-slate-800 rounded-2xl p-8 md:p-12 border border-border dark:border-dark-border shadow-sm">
            <div className="w-16 h-16 rounded-full bg-primary/10 flex items-center justify-center mx-auto mb-6">
              <Award className="text-primary dark:text-accent-light" size={32} aria-hidden="true" />
            </div>
            <h2 id="founding-heading" className="text-2xl font-bold text-ink dark:text-white mb-4">
            ...
            <p className="text-muted dark:text-dark-muted text-lg leading-relaxed mb-4">
              ...
              <time dateTime={orgData.founded} className="font-bold text-ink dark:text-white">
                {orgData.foundedDisplay}
              </time>
